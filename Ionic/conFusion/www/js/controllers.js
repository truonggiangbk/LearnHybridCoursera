...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'baseURL', '$ionicPopover', 'favoriteFactory', '$ionicModal', '$ionicListDelegate',
    function($scope, $stateParams, dish, menuFactory, baseURL, $ionicPopover, favoriteFactory, $ionicModal, $ionicListDelegate) {
        $scope.baseURL = baseURL;
        $scope.dish = {};
...
.controller('IndexController', ['$scope', 'menuFactory', 'corporateFactory', 'promotionFactory', 'baseURL', 'dish', 'promotion', 'leader', function($scope, menuFactory, corporateFactory, promotionFactory, baseURL, dish, promotion, leader) {
